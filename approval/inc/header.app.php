...
if (isset($_SESSION['emp_login']['emp_id'])){
    if ((time() - $_SESSION['emp_last_login_timestamp']) > 3600){
...
<head>
    ...
    <base href="http://localhost/performance_sheet/approval/">
            ...
            <div id="userbox" class="userbox">
                <a href="javascript:void(0)" data-bs-toggle="dropdown">
                    ...
                    <div class="profile-info" data-lock-name="John Doe" data-lock-email="test@test.com">
                        <span class="name"><?=$_SESSION['emp_login']['emp_name'];?> (Approval)</span>
                ...
                <div class="nano-content">
                    <nav id="menu" class="nav-main" role="navigation">
                        <ul class="nav nav-main">
                            ...
                            <li class="<?php if (basename($_SERVER['PHP_SELF']) == 'analysis.php') echo "nav-active";?>">
                                <a class="nav-link" href="analysis">
                                    <i class="bx bx-line-chart" aria-hidden="true"></i><span>Analysis</span>
                                </a>
                            </li>
                    ...
                    <div class="sidebar-widget widget-tasks">
                        <div class="widget-header"><h6>APPROVAL PAGE </h6></div>
                        <div class="widget-content">
                            <ul class="list-unstyled m-0" style="list-style: none">
                                <li><a href="approval-page">Approve Performance Sheet</a></li>
                            </ul>
                        </div>
                    </div>
                    <hr class="separator" />
