...
<?php include_once("inc/helpers.php"); ?>
<!DOCTYPE html>
<html lang="">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Admin: Performance Sheet</title>
    <meta name="keywords" content="Admin Performance Sheet" />
    <meta name="description" content="TEP - Admin Performance Sheet">
    <meta name="author" content="Admin Performance Sheet">
    ...
    <link rel="stylesheet" href="../assets/css/skin-corporate-21.css" id="skinCSS">
    <link rel="stylesheet" href="../assets/css/custom.css">
    <link rel="stylesheet" href="../assets/css/jquery-confirm.min.css">
    <style>
        #login-page,#register-page {
            height: 100vh;background-image: url('../assets/images/main-background-img.png');
            background-size: cover;background-repeat: no-repeat;background-position: center;
        }
        .header-text{font-size: 25px;font-weight: bolder;display: flex;align-items: center;}
    </style>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="row">
                        <div class="col-md-12 align-self-center p-static order-2 text-center">
                            <h1 class="font-weight-bold text-dark">Admin Login</h1>
                        </div>
                    </div>
                    <div class="tabs">
                            ...
                            <form id="admin_login_form" name="admin_login_form">
                                ...
                                <div class="row">
                                    <div class="form-group col">
                                        ...
                                        <input type="email" class="form-control shadow-none" id="adm_email" name="adm_email" placeholder="Enter email">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col">
                                        <label class="form-label text-color-dark text-3">Password <span class="text-color-danger">*</span></label>
                                        <input type="password" class="form-control shadow-none" id="adm_password" name="adm_password" placeholder="Enter password">
                                    </div>
                                </div>
                                <div class="row">
